...
module.exports=function(e,t,n,r){function o(){var e;return e=J?S:L.instance_url?L.instance_url:C,"/"===e.slice(-1)&&(e=e.slice(0,-1)),e}function s(e){var t=decodeURIComponent(e),n={},r=t.split("&");return r.forEach(function(e){var t=e.split("=");n[t[0]]=t[1]}),n}function a(e){var t,n=[];for(t in e)e.hasOwnProperty(t)&&n.push(encodeURIComponent(t)+"="+encodeURIComponent(e[t]));return n.join("&")}function c(e){q.authenticate(function(t){L.access_token=t.accessToken,H.forceOAuth=JSON.stringify(L),e.resolve()},function(){console.log("Error refreshing oauth access token using the oauth plugin"),e.reject()})}function i(e){var t={grant_type:"refresh_token",refresh_token:L.refresh_token,client_id:w},n={},o=J?S:E;"/"===o.slice(-1)&&(o=o.slice(0,-1)),o=o+"/services/oauth2/token?"+a(t),J||(n["Target-URL"]=E),r({headers:n,method:"POST",url:o,params:t}).success(function(t,n,r,o){console.log("Token refreshed"),L.access_token=t.access_token,H.forceOAuth=JSON.stringify(L),e.resolve()}).error(function(t,n,r,o){console.log("Error while trying to refresh token"),e.reject()})}function u(){var e=t.defer();return q?c(e):i(e),e.promise}function p(e){if(P=!0,!e.appId)throw"forceng appId is required on init";if(!e.oauthCallbackURL)throw"forceng oauthCallbackURL is requried on init";w=e.appId,x=e.oauthCallbackURL,N=e.apiVersion||N,E=e.loginURL||E,S=e.proxyURL||S,J=void 0===e.useProxy?J:e.useProxy,e.accessToken&&(L||(L={}),L.access_token=e.accessToken),e.instanceURL&&(L||(L={}),L.instance_url=e.instanceURL),e.refreshToken&&(L||(L={}),L.refresh_token=e.refreshToken)}function d(){delete L.access_token,H.forceOAuth=JSON.stringify(L)}function f(e){var t,n;e.indexOf("access_token=")>0?(t=e.substr(e.indexOf("#")+1),n=s(t),L=n,H.forceOAuth=JSON.stringify(L),I&&I.resolve()):e.indexOf("error=")>0?(t=decodeURIComponent(e.substring(e.indexOf("?")+1)),n=s(t),I&&I.reject(n)):I&&I.reject({status:"access_denied"})}function h(){return window.cordova||window.SfdcApp}function l(){if(!P)throw"init must be called before a login is attempted";return I=t.defer(),h()?k():v(),I.promise}function v(){document.addEventListener("deviceready",function(){return(q=cordova.require("com.salesforce.plugin.oauth"))?void q.getAuthCredentials(function(e){p({accessToken:e.accessToken,instanceURL:e.instanceUrl,refreshToken:e.refreshToken}),I&&I.resolve()},function(e){I&&I.reject(e)}):(console.error("Salesforce Mobile SDK OAuth plugin not available"),void(I&&I.reject({status:"Salesforce Mobile SDK OAuth plugin not available"})))},!1)}function k(){var e=E+"/services/oauth2/authorize?client_id="+w+"&redirect_uri="+x+"&response_type=token";window.open(e,"_blank","location=no")}function g(){return"undefined"!=typeof L?L.id.split("/").pop():void 0}function m(){return L&&L.access_token?!0:!1}function _(e){if(!P)throw"ForceNG init was not called; you must call init before making requests";var n=e.method||"GET",s={},a=o(),c=t.defer();return L&&(L.access_token||L.refresh_token)?("/"!==e.path.charAt(0)&&(e.path="/"+e.path),a+=e.path,s.Authorization="Bearer "+L.access_token,e.contentType&&(s["Content-Type"]=e.contentType),J&&(s["Target-URL"]=L.instance_url),r({headers:s,method:n,url:a,params:e.params,data:e.data}).success(function(e,t,n,r){c.resolve(e)}).error(function(t,n,r,o){401===n&&L.refresh_token?u().success(function(){_(e)}).error(function(){console.error(t),c.reject(t)}):(console.error(t),c.reject(t))}),c.promise):(c.reject("No access token. Login and try again."),c.promise)}function T(e){return _({path:"/services/data/"+N+"/query",params:{q:e}})}function y(e,t,n){return _({path:"/services/data/"+N+"/sobjects/"+e+"/"+t,params:n?{fields:n}:void 0})}function b(e,t){return _({method:"POST",contentType:"application/json",path:"/services/data/"+N+"/sobjects/"+e+"/",data:t})}function j(e,t){var n=t.Id,r=angular.copy(t);return delete r.attributes,delete r.Id,_({method:"POST",contentType:"application/json",path:"/services/data/"+N+"/sobjects/"+e+"/"+n,params:{_HttpMethod:"PATCH"},data:r})}function O(e,t){return _({method:"DELETE",path:"/services/data/"+N+"/sobjects/"+e+"/"+t})}function U(e,t,n,r){return _({method:"PATCH",contentType:"application/json",path:"/services/data/"+N+"/sobjects/"+e+"/"+t+"/"+n,data:r})}function A(e){var t;return e.substring?t={path:e}:(t=e,"/"!==t.path.charAt(0)&&(t.path="/"+t.path),"/services/apexrest"!==t.path.substr(0,18)&&(t.path="/services/apexrest"+t.path)),_(t)}function R(e){var t="/services/data/"+N+"/chatter";return e&&e.path?("/"!==e.path.charAt(0)&&(e.path="/"+e.path),e.path=t+e.path,_(e)):void errorHandler("You must specify a path for the request")}var w,L,C,S,x,I,q,E="https://login.salesforce.com",P=!1,N="v33.0",H={},J=h()?!0:!1;return{init:p,login:l,getUserId:g,isAuthenticated:m,request:_,query:T,create:b,update:j,del:O,upsert:U,retrieve:y,apexrest:A,chatter:R,discardToken:d,oauthCallback:f}};
},{}],2:[function(require,module,exports){
"use strict";var app=require("angular").module("forceng").factory("force",require("./force"));module.exports="forceng";
},{"./force":1,"angular":4}],3:[function(require,module,exports){
...
//# sourceMappingURL=dist/bundle.map.json